...
private:
    ...
    {
        clsFindCurrancyScreen::ShowFindCurrencyScreen();
    ...
    static void  _PerformCurrenciesMainMenueOptions(enCurrenciesMainMenueOptions op)
    {
        switch (op)
        {
        case clsCurrencyExchangeMainScreen::enListCurrencies:
            system("cls");
        ...
        case clsCurrencyExchangeMainScreen::enUpdateCurrencyRate:
            ...
            _GoBackToCurrenciesMenue();
            break;
        case clsCurrencyExchangeMainScreen::enCurrencyCalculator:
            system("cls");
            _ShowCurrencyCalculatorScreen();
            _GoBackToCurrenciesMenue();
            break;
        case clsCurrencyExchangeMainScreen::enMainMenue:
            break;
        }
    }
